...
export const skillLines: SkillLine[] = [
	...
	{ type: 'skill', text: '   ✦ LLM APIs · SSE · WebSocket · WebRTC' },
	{ type: 'gap' },
...
export const JOBS: ExperienceJob[] = [
	{
		...
		bullets: [
			...
			'Integrated multiple LLM providers to enable dynamic model selection for AI-driven features including content generation, and AI tutor chat.',
			'Implemented spaced repetition, interactive quizzes, rich-text notes, basic learning analytics, and text-to-speech playback.',
			'Developed collaboration features including shareable study materials, study groups, and shared courses.',
			'Implemented a DDD-based modular architecture with layered separation (Domain, Application, API Infrastructure) and CQRS using MediatR to improve maintainability and scalability.',
		],
		tech: [
			'React.js',
			'TypeScript',
		...
		screenshots: [
			...
			'/images/experience/StudyPlatform8.png',
		],
		highlights: [
			{
				icon: '🧠',
	...
	},
	{
		...
		bullets: [
			'Led frontend development for a new AI product using React and modern web technologies.',
			'Built a Chrome Extension with features including video summarization, AI chat, mind maps, and note-taking.',
			'Implemented streaming responses using SSE to improve user experience.',
			'Contributed to product growth, reaching 30K+ users within 3 months.',
		],
	...
	},
	{
		...
		bullets: [
			'Developed frontend and cross-platform applications for healthcare systems.',
			'Contributed to a low-code platform to support internal product development.',
			'Built features for digital therapy and electronic health record systems.',
			'Participated in development of a scoliosis measurement tool.',
		],
	...
	},
	{
		...
		bullets: [
			'Developed frontend features for financial systems including wallet and credit card products.',
			'Contributed to full-stack features in the Local Life platform.',
			'Supported personalised campaign features to improve user engagement.',
		],
	...
	},
	{
		...
		bullets: [
			'Improved system performance and load time through frontend optimisations, contributing to more stable and responsive applications.',
			'Built internal tools for monitoring and debugging.',
			'Developed features for telehealth and prescription systems.',
		],
